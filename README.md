...
![Rust](https://img.shields.io/badge/Rust-1.93+-f74c00?style=for-the-badge&logo=rust&logoColor=white)
![License](https://img.shields.io/badge/License-MIT-green?style=for-the-badge)
![MCP](https://img.shields.io/badge/MCP-Protocol-blueviolet?style=for-the-badge)
![SSH](https://img.shields.io/badge/SSH-Secure-blue?style=for-the-badge&logo=openssh&logoColor=white)

**🦀 A Rust MCP (Model Context Protocol) server that enables Claude Code to execute commands on air-gapped environments via SSH.**

[🤔 What is this?](#-what-is-this) • [⚡ Quick Start](#-quick-start) • [🎯 Features](#-features) • [⚙️ Configuration](#️-configuration) • [🔒 Security](#-security) • [🔧 Tools](#-tools-197) • [🛠️ Development](#️-development)
...
- 🦀 Rust 1.93 or higher
- 🔑 SSH access to target hosts (SSH key configured)
...
Local CI pipeline via `make ci` + GitHub Actions for releases:

| Stage | Command | Description |
|-------|---------|-------------|
| 📝 Format | `make fmt-check` | rustfmt verification |
| 🔍 Lint | `make lint` | clippy with strict warnings |
| 🧪 Tests | `make test` | Unit and integration tests |
| 🔐 Audit | `cargo audit` | Security advisory check |
| 📝 Typos | `typos` | Spell check |
| 🔨 Release | `make release-all` | Cross-compile 5 platforms |

> [!NOTE]
> GitHub Actions is used for automated release builds. Local development uses `make ci`.
