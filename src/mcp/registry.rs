...
pub fn tool_group(tool_name: &str) -> &'static str {
    match tool_name {
        ...
        | "ssh_template_diff" => "templates",
        "ssh_pty_exec" | "ssh_pty_interact" | "ssh_pty_resize" => "pty",
        ...
        "ssh_file_read" | "ssh_file_write" | "ssh_files_write" | "ssh_file_chmod"
        | "ssh_file_chown" | "ssh_file_stat" | "ssh_file_diff" | "ssh_file_patch"
        | "ssh_file_template" => "file_ops",
        // User Management
        ...
        | "ssh_apparmor_status"
        | "ssh_apparmor_profiles"
        | "ssh_security_audit" => "security_modules",
        // Network Equipment
        "ssh_net_equip_show_run"
        | "ssh_net_equip_show_interfaces"
        | "ssh_net_equip_show_routes"
        | "ssh_net_equip_show_arp"
        | "ssh_net_equip_show_version"
        | "ssh_net_equip_show_vlans"
...
pub fn tool_annotations(tool_name: &str) -> ToolAnnotations {
    match tool_name {
        ...
        // Config Templates
        "ssh_template_list" => ToolAnnotations::read_only("Template List"),
        "ssh_template_show" => ToolAnnotations::read_only("Template Show"),
        "ssh_template_apply" => ToolAnnotations::destructive("Template Apply"),
        "ssh_template_validate" => ToolAnnotations::read_only("Template Validate"),
        "ssh_template_diff" => ToolAnnotations::read_only("Template Diff"),

        // Interactive PTY
        "ssh_pty_exec" => ToolAnnotations::mutating("PTY Execute"),
        "ssh_pty_interact" => ToolAnnotations::mutating("PTY Interact"),
        "ssh_pty_resize" => ToolAnnotations::read_only("PTY Resize"),
        ...
        "ssh_files_write" => ToolAnnotations::destructive("Write Multiple Remote Files"),
...
pub fn create_filtered_registry(tool_groups: &ToolGroupsConfig) -> ToolRegistry {
    ...
    let all_handlers: Vec<Arc<dyn ToolHandler>> = vec![
        ...
        Arc::new(SshFileWriteHandler),
        Arc::new(SshFilesWriteHandler),
